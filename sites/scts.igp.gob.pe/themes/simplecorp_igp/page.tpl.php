                ...
                <div id="header-igp">
                    <div id="logo-minam">
                        <?php if (theme_get_setting('l_minam_igp_area')== ''):?>
                         <a href="<?php print $front_page; ?>" title="<?php print t('Home'); ?>" rel="home"><img src="<?php print base_path() . drupal_get_path('theme', 'simplecorp')?>/images/logo-scts-web.png" alt="IGP Logo"/></a>
                        <?php else: ?>
