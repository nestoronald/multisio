        ...
        <footer id="footer">
            ...
            <div id="footer-bottom">
                <div class="container clearfix">
                    ...
                    //print drupal_render($main_menu_tree); ?>
                   	<div class="credits"> 
                    <center><p>Instituto Geofísico del Perú  - Sub Dirección de Geofísica y Sociedad | 
                        <a href="http://test.igp.gob.pe/gso/?q=datos-de-contacto" class="mostaza">Contacto </a>| Escríbenos a: <a href="mailto:web@igp.gob.pe" class="mostaza" rel="propover">web@igp.gob.pe</a> | Lima 
                    </p></center>
                    </div>
