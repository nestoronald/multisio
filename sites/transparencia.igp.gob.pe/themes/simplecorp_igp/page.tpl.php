                ...
                <div id="header-igp">
                    <div id="logo-minam">
                        <?php if (theme_get_setting('l_minam_igp_area')== ''):?>
                         <a href="<?php print $front_page; ?>" title="<?php print t('Home'); ?>" rel="home"><img src="<?php print base_path() . drupal_get_path('theme', 'simplecorp')?>/images/logo-transparencia-web.png" alt="IGP Logo"/></a>
                        <?php else: ?>
        ...
        <footer id="footer">
            ...
            <div id="footer-bottom">
                <div class="container clearfix">
                    ...
                    <center><p>Dirección: Calle Calatrava s/n – Urb. Camacho – La Molina  |  Central Telefónica: 317-2300 |
                        <a href="/?q=node/244" class="mostaza">Cont&aacute;ctenos </a>| Escríbenos a: <a href="mailto:otidg_uis@igp.gob.pe" class="mostaza" rel="propover">otidg_uis@igp.gob.pe</a>
                    </p></center>
                    </div>
