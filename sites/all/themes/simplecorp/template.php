	...
	drupal_add_js('
		jQuery(document).ready(function($) {
			...
			/*jQuery(\'.view-id-features_articles ul li\').each(function(i){
				...
				texto = jQuery(this).find(\'.views-field-body p\').eq(1).html();
				jQuery(this).find(\'.views-field-body p\').eq(1).html(texto+\'... <div><a href="\'+link+\'" title="Click aqui para mas información">Leer más</a></div>\');
			})*/
	...
	drupal_add_js('
		jQuery(document).ready(function($) {
		    ...
		    $(window).load(function() {
		        ...
		        $("ul#projects-carousel_1").fadeIn("fast");
